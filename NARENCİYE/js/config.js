...
const FRUIT_TYPES = [
    ...
    { id: 'orange', imgId: 'imgOrange', color: '#FF6600', name: 'Washington Portakal', points: 20, glow: '#FF7722' },
    { id: 'mandarin', imgId: 'imgMandarin', color: '#FF4400', name: 'Satsuma Mandalina', points: 20, glow: '#FF5522' },
